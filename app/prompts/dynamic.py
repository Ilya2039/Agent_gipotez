...
def build_decide_next_action_prompt(
    ...
    return (
        "РОЛЬ: Старший консультант по стратегии с отраслевой специализацией.\n"
        + "ЦЕЛЬ: вести диагностический диалог, минимизируя шум и повторения, и принимать решение о следующем шаге.\n"
        + "ФОКУС: отраслевые тренды, подотрасли, практики конкурентов, операционные и клиентские особенности.\n"
        + deprior
...
def build_generate_discovery_question_prompt(
    ...
    return (
        "РОЛЬ: Старший интервьюер/аналитик.\n"
        + "ЦЕЛЬ: уточнить деятельность компании: отрасль/подотрасль, продукты, клиенты, каналы, процессы, задачи и боли.\n"
...
def build_generate_free_hypothesis_prompt(
    ...
    return (
        ...
        + "ЦЕЛЬ: сформулировать одну прикладную гипотезу по теме с опорой на отраслевую специфику.\n"
